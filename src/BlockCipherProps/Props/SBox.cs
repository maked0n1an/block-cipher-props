namespace BlockCipherProps.Props
{
    public class SBox
    {
        ...
        private readonly byte[][] _reversedSBox = new byte[][]
        {
        ...
        public SBox(byte[][] sBox, byte[][] reversedSBox)
        {
            this._sBox = sBox;
            this._reversedSBox = reversedSBox;
        }

        public byte Lookup(byte b)
        {
            return Lookup(this._sBox, b);
        }

        public byte ReverseLookup(byte b)
        {
            return Lookup(this._reversedSBox, b);
        }

        private byte Lookup(byte[][] sBox, byte b)
        {
            byte left = (byte)(b >> 4);
